...
htmllinkcss($htmllinkcss = '');# a  simle <style> tag with addons for example htmllinkcss($htmllinkcss = 'http://exmaple.com/exmaple.css');
...
htmlfromfile($htmlfromfile = 'http://example.com');# get html from URL or file
htmlbodyend();
htmlend();
